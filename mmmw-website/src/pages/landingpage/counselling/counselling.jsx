...
export default function Counselling() {
  ...
  return(
    <div id="counsel-sect-cont" className='w-full relative bg-purple'>
      ...
      <div className='max-w-[1500px]  px-10 flex flex-col mx-auto'>
        ...
        <div id="counsel-sect-cta" className='flex flex-row gap-5 items-center mx-auto  py-10'>
          <a href='https://calendly.com/kemie72' target='_blank' className='hover:drop-shadow-xl w-[180px] bg-pink text-darkpurple rounded-xl p-4 font-bold text-center'> Explore Counseling</a> 
          <div className='hidden xs2:flex h-12 w-[2px] bg-pink'> </div>
          <a className='hover:underline hidden xs2:flex p-5 w-[180px] rounded-xl text-center text-pink font-bold'> Learn more</a>
